set fallback := true
set shell := ["bash", "-uc"]
set windows-shell := ["powershell.exe", "-NonInteractive"]
...
convex *ARGS:
  cd {{invocation_directory()}}; npx convex dev --admin-key 0135d8598650f8f5cb0f30c34ec2e2bb62793bc28717c8eb6fb577996d50be5f4281b59181095065c5d0f86a2c31ddbe9b597ec62b47ded69782cd --url "http://127.0.0.1:3210"
